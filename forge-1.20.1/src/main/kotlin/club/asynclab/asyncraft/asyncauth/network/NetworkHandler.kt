...
object NetworkHandler {
    ...
    fun onCommonSetup(event: FMLCommonSetupEvent) {
        LOGIN.messageBuilder(PacketInit::class.java, id++)
            ...
            .consumerNetworkThread(PacketInit::handle)
