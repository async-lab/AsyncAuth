...
import club.asynclab.asyncraft.asyncauth.command.CommandUser
...
object ModCommands {
    fun onRegisterCommands(event: RegisterCommandsEvent) {
        event.dispatcher.apply {
            val main = register(Commands.literal("asyncauth")
                .then(CommandAdmin.getBuilder())
                .then(CommandUser.getBuilder()))
